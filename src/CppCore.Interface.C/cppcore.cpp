...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// WASM/WASI EXTERNAL SYMBOLS
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#if defined(CPPCORE_OS_WASI)
...
void* cppcore_alloc(unsigned int size) { return CPPCORE_ALIGNED_ALLOC(size, 16); }
void  cppcore_free (void* ptr)         { CPPCORE_ALIGNED_FREE(ptr); }

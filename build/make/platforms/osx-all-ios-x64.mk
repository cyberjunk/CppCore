...
INCLUDES   = 
CXX        = clang++
CXXFLAGS   = $(MINVER) -target $(TARGET) -isysroot $(SDKROOT) -static -fno-strict-aliasing -fno-strict-overflow
CC         = clang
CFLAGS     = $(MINVER) -target $(TARGET) -isysroot $(SDKROOT) -static -fno-strict-aliasing -fno-strict-overflow
AR         = ar
ARFLAGS    = rcs
STRIP      = strip
STRIPFLAGS = -S

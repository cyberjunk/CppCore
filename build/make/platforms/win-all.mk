...
define deletefiles
	-$(shell del /s /q $(subst /,\,$(1))\$(2) >nul 2>&1)
endef
...
define makepkg
	$(shell MakeAppx.exe build /o /h SHA256 /f $(subst /,\,$(1)) /op $(subst /,\,$(2)) >nul 2>&1)
endef

# Create APPXBUNDLE
define makebundle
	$(shell MakeAppx.exe bundle /o /d $(subst /,\,$(1)) /p $(subst /,\,$(2)) >nul 2>&1)
endef

# Sign File with pfx without password
define sign
	$(shell if exist $(subst /,\,$(1)) SignTool.exe sign /a /fd SHA256 /td SHA256 /tr http://timestamp.digicert.com /f $(subst /,\,$(2)) $(subst /,\,$(1)) >nul 2>&1)
endef

# Sign File with pfx with password
define signp
	$(shell if exist $(subst /,\,$(1)) SignTool.exe sign /a /fd SHA256 /td SHA256 /tr http://timestamp.digicert.com /f $(subst /,\,$(2)) /p $(3) $(subst /,\,$(1)) >nul 2>&1)
endef

# Create .pri resources
define makepri
	$(shell MakePri.exe new /v /o /cf $(subst /,\,$(1)) /pr $(subst /,\,$(2)) /of $(subst /,\,$(3)) /IndexName $(4))
endef

...
INCLUDES   = 
CXX        = clang++
CXXFLAGS   = $(MINVER) -target $(TARGET) -static -fno-strict-aliasing -fno-strict-overflow
CC         = clang
CFLAGS     = $(MINVER) -target $(TARGET) -static -fno-strict-aliasing -fno-strict-overflow
AR         = ar
ARFLAGS    = rcs
STRIP      = strip
STRIPFLAGS = -S

...
ifeq ($(DETECTED_OS),win)
	start "" $(EMULATOR) -no-window -no-audio -no-snapshot -gpu swiftshader_indirect -avd $(NAME)_AVD
else
	$(EMULATOR) -no-window -no-audio -no-snapshot -gpu swiftshader_indirect -avd $(NAME)_AVD &
endif

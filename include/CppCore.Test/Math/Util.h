   ...
   public:
      ...
      NOINLINE static bool clmul64to128()
      {
         ...
         *pr32 = 0U; pr32++;*/
         ...
         a = (uint64_t)0x0000000000000002ULL; b = (uint64_t)0x0000000000000003ULL; CppCore::clmul(a, b, r); if (r.l != (uint64_t)0x0000000000000006ULL || r.h != (uint64_t)0x0000000000000000ULL) return false;
         a1 = (uint64_t)0x5b477565726f6e5dULL; b1 = (uint64_t)0x63746f725d53475dULL; CppCore::clmul(a1, b1, r2); if (r2.l != (uint64_t)0x929633d5d36f0451ULL || r2.h != (uint64_t)0x1d4d84c85c3440c0ULL) return false;
         //a = (uint64_t)0x4869285368617929ULL; b = (uint64_t)0x63746f725d53475dULL; CppCore::clmul(a, b, r); if (r.l != (uint64_t)0x7fa540ac2a281315ULL || r.h != (uint64_t)0x1bd17c8d556ab5a1ULL) return false;

   ...
   public:
      ...
      NOINLINE static bool clmul64to128()
      {
         ...
         *pr32 = 0U; pr32++;*/
         ...
         a1 = (uint64_t)0x5b477565726f6e5dULL; b1 = (uint64_t)0x63746f725d53475dULL; CppCore::clmul(a1, b1, r); if (r.l != (uint64_t)0x929633d5d36f0451ULL || r.h != (uint64_t)0x1d4d84c85c3440c0ULL) return false;
